<script lang="ts">
  ...
  <div class="device">
	<div class="screen">
	  <section class="mobile-landing">
		...
		<p class="tagline">
		  Turn self-care into an adventure. Complete missions, earn rewards, and level up your wellbeing!
		</p>
  ...
  <style>
	...
	.screen .mobile-landing {
	  ...
	  align-items: center;
	  padding: 1.5rem;
	  background: linear-gradient(135deg, hsl(190,85%,93%), hsl(250,85%,93%));
	  text-align: center;
